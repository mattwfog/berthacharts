...
fn demo_sankey_spec() -> SankeySpec {
    SankeySpec::new(
        ...
        vec![
            SankeyLink::new("website", "organic", 70.0, "source mix", rgba(0.07, 0.45, 0.78, 0.62)),
            SankeyLink::new("website", "paid", 54.0, "source mix", rgba(0.05, 0.58, 0.64, 0.58)),
            SankeyLink::new("website", "referral", 32.0, "source mix", rgba(0.12, 0.60, 0.43, 0.54)),
            SankeyLink::new("organic", "trial", 48.0, "activation", rgba(0.05, 0.48, 0.74, 0.58)),
            SankeyLink::new("organic", "sales", 22.0, "sales assist", rgba(0.38, 0.53, 0.28, 0.46)),
            SankeyLink::new("paid", "trial", 36.0, "activation", rgba(0.05, 0.58, 0.64, 0.56)),
            SankeyLink::new("paid", "sales", 18.0, "sales assist", rgba(0.38, 0.53, 0.28, 0.46)),
            SankeyLink::new("referral", "sales", 32.0, "partner lift", rgba(0.12, 0.60, 0.43, 0.52)),
            SankeyLink::new("trial", "won", 58.0, "converted", rgba(0.04, 0.56, 0.38, 0.64)),
            SankeyLink::new("trial", "lost", 26.0, "drop-off", rgba(0.74, 0.25, 0.20, 0.50)),
            SankeyLink::new("sales", "won", 34.0, "converted", rgba(0.04, 0.56, 0.38, 0.58)),
            SankeyLink::new("sales", "lost", 38.0, "drop-off", rgba(0.74, 0.25, 0.20, 0.50)),
        ],
    )
    .with_stages(vec![
